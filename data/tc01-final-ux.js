(function(){
  ...
  function patch(){
    ...
    if(declaration)declaration.textContent='J’ai relu ma note de dossier, comparé mon travail aux critères du module et laissé visibles les points que je ne peux pas trancher seul.';
    ...
    if(practical){
      ...
      if(intro)intro.innerHTML='Comparez votre <strong>note de dossier</strong> aux 4 critères ci-dessous. Le score est calculé automatiquement. Seuil: <strong>80/100</strong>; aucune erreur critique ni réponse «je ne sais pas» n’est admise.';
    }
    ...
    if(quizHeading)quizHeading.textContent='Challenge final · 8 situations de travail';
  }
