...
3. TC03 — Protection des données, accès et incidents
4. TC04 — KYC, ayant droit économique et périmètre LBA
...
## Règle de non-assistance pendant la première tentative

Une intervention immédiate est justifiée uniquement si:

- le learner risque d’utiliser des données réelles dans l’édition publique;
...
- **UX — interface:** navigation, libellé ou interaction induisant l’erreur;
