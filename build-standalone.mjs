...
const [css, appData, roadmapData, tc01v14, tc02v10, tc03v10, tc04v10, app, runtimeEnhancements, autonomyObserverGuard, autonomyFirst, beginnerUx] = await Promise.all([
...
console.log(`Standalone généré: ${html.length} caractères · 4/25 modules complets · autonomie-first + beginner UX activés`);
